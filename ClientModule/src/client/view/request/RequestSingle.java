...
public class RequestSingle extends JPanel {
    ...
    public RequestSingle() {
        ...
        setLayout(new GridLayoutManager(5, 2, new Insets(0, 0, 0, 0), 5, 0));

        //======== panel4 ========
        {
            panel4.setBackground(FrontEnd.COLOR_LIGHT);
            panel4.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), 5, 0, false, true));
        ...
        //---- label4 ----
        label4.setText(Text.bundle.getString(Text.CUSTOMER));
        label4.setFont(FrontEnd.FONT_BOLD);
        label4.setBorder(new EmptyBorder(0, 5, 0, 0));
        add(label4, new GridConstraints(1, 0, 1, 1,
                GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                null, null, null));
        ...
        add(lblTariff, new GridConstraints(2, 1, 1, 1,
                GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                null, null, null));
        ...
        add(label7, new GridConstraints(4, 0, 1, 1,
                GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                null, null, null));
        ...
        add(lblDate, new GridConstraints(4, 1, 1, 1,
                GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                null, null, null));
        ...
        btnMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ClientMainScreen.showRequestApprove(request);
            }
        });
    }

    public RequestSingle loadPanel(Request request) {
        this.request = request;
        lblName.setText(request.client.name);
